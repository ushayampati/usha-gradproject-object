package com.usha.feereport.admin;

import com.usha.feereport.FeeReport;
import com.usha.feereport.accountant.AddAccountant;
import com.usha.feereport.accountant.ViewAccountant;
...
public class AdminSection extends JFrame {
    ...
    // Create the Admin Section frame.
    ...
    public AdminSection() {
        ...
        groupLayout.setVerticalGroup(
                groupLayout.createParallelGroup(Alignment.LEADING)
                        .addGroup(groupLayout.createSequentialGroup()
                                .addComponent(lblAdminSection).addGap(29)
                                .addComponent(btnAddAccountant, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE).addGap(18)
                                .addComponent(btnViewAccountant, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE).addGap(18)
